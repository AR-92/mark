...
show_help() {
    ...
    echo -e "    ${COLOR_SOLAR_CYAN}generate${COLOR_RESET} (${COLOR_SOLAR_CYAN}g${COLOR_RESET}) ${COLOR_SOLAR_SKY}<template>${COLOR_RESET} ${COLOR_SOLAR_AQUA}[data]${COLOR_RESET}    ${COLOR_SOLAR_TEAL}Generate prompt from template${COLOR_RESET} ${EMOJI_TOOL}"
    echo -e "    ${COLOR_SOLAR_CYAN}list${COLOR_RESET} (${COLOR_SOLAR_CYAN}l${COLOR_RESET})                          ${COLOR_SOLAR_TEAL}List recently generated prompts${COLOR_RESET} ${EMOJI_LIST:-📋}"
    echo -e "    ${COLOR_SOLAR_CYAN}clear${COLOR_RESET} (${COLOR_SOLAR_CYAN}c${COLOR_RESET})                         ${COLOR_SOLAR_TEAL}Clear all logs${COLOR_RESET} ${EMOJI_CLEAR:-🧹}"
    echo -e "    ${COLOR_SOLAR_CYAN}config${COLOR_RESET} (${COLOR_SOLAR_CYAN}cfg${COLOR_RESET}) ${COLOR_SOLAR_AQUA}[set|get|list]${COLOR_RESET} ${COLOR_SOLAR_SKY}[key]${COLOR_RESET} ${COLOR_SOLAR_AQUA}[value]${COLOR_RESET}  ${COLOR_SOLAR_TEAL}Manage configuration${COLOR_RESET} ${EMOJI_CONFIG:-⚙️}"
    echo -e "    ${COLOR_SOLAR_CYAN}template${COLOR_RESET} (${COLOR_SOLAR_CYAN}t${COLOR_RESET}) ${COLOR_SOLAR_AQUA}[list|show|new|edit|delete|rename]${COLOR_RESET} ${COLOR_SOLAR_SKY}[args]${COLOR_RESET}  ${COLOR_SOLAR_TEAL}Manage templates${COLOR_RESET} ${EMOJI_TEMPLATE:-📄}"
    echo -e "    ${COLOR_SOLAR_CYAN}upgrade${COLOR_RESET} (${COLOR_SOLAR_CYAN}u${COLOR_RESET})                       ${COLOR_SOLAR_TEAL}Upgrade mark to latest version${COLOR_RESET} ${EMOJI_UPGRADE:-⬆️}"
    echo -e "    ${COLOR_SOLAR_CYAN}uninstall${COLOR_RESET} (${COLOR_SOLAR_CYAN}un${COLOR_RESET})                     ${COLOR_SOLAR_TEAL}Uninstall mark from your system${COLOR_RESET} ${EMOJI_UNINSTALL:-🗑️}"
    echo -e "    ${COLOR_SOLAR_CYAN}version${COLOR_RESET} (${COLOR_SOLAR_CYAN}v${COLOR_RESET})                       ${COLOR_SOLAR_TEAL}Show version information${COLOR_RESET} ${EMOJI_VERSION}"
    echo -e "    ${COLOR_SOLAR_CYAN}help${COLOR_RESET} (${COLOR_SOLAR_CYAN}h${COLOR_RESET})                          ${COLOR_SOLAR_TEAL}Show this help message${COLOR_RESET} ${EMOJI_HELP:-❓}"
    echo ""
    ...
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}g${COLOR_RESET} ${COLOR_SOLAR_SKY}my_template.md${COLOR_RESET}"
    ...
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}g${COLOR_RESET} ${COLOR_SOLAR_SKY}-i${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}list${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}l${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}clear${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}c${COLOR_RESET}"
    ...
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}cfg${COLOR_RESET} ${COLOR_SOLAR_TEAL}set${COLOR_RESET} ${COLOR_SOLAR_SKY}editor${COLOR_RESET} ${COLOR_SOLAR_AQUA}nvim${COLOR_RESET}"
    ...
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}cfg${COLOR_RESET} ${COLOR_SOLAR_TEAL}get${COLOR_RESET} ${COLOR_SOLAR_SKY}editor${COLOR_RESET}"
    ...
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}t${COLOR_RESET} ${COLOR_SOLAR_TEAL}list${COLOR_RESET}"
    ...
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}t${COLOR_RESET} ${COLOR_SOLAR_TEAL}show${COLOR_RESET} ${COLOR_SOLAR_SKY}my_template.md${COLOR_RESET}"
    ...
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}t${COLOR_RESET} ${COLOR_SOLAR_TEAL}new${COLOR_RESET} ${COLOR_SOLAR_SKY}my_new_template${COLOR_RESET} ${COLOR_SOLAR_AQUA}--wizard${COLOR_RESET}"
    ...
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}t${COLOR_RESET} ${COLOR_SOLAR_TEAL}edit${COLOR_RESET} ${COLOR_SOLAR_SKY}my_template.md${COLOR_RESET}"
    ...
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}t${COLOR_RESET} ${COLOR_SOLAR_TEAL}delete${COLOR_RESET} ${COLOR_SOLAR_SKY}my_template.md${COLOR_RESET}"
    ...
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}t${COLOR_RESET} ${COLOR_SOLAR_TEAL}rename${COLOR_RESET} ${COLOR_SOLAR_SKY}old_name${COLOR_RESET} ${COLOR_SOLAR_AQUA}new_name${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}upgrade${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}u${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}uninstall${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}un${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}version${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}v${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}help${COLOR_RESET}"
    echo -e "    ${COLOR_SOLAR_LIGHT_BLUE}mark${COLOR_RESET} ${COLOR_SOLAR_CYAN}h${COLOR_RESET}"
    echo ""
