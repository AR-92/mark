...
show_detailed_help() {
    ...
    case "$1" in
        ...
        tui)
            ...
            echo "    Features a clean design with Solarized blue color scheme and enhanced visual elements."
            echo ""
            echo "REQUIREMENTS:"
        ...
        upgrade|u)
            ...
            echo "    Now includes enhanced upgrade functionality that properly handles all"
            echo "    TUI files including the enhanced box-free version."
            echo ""
            echo "PROCESS:"
            ...
            echo "    4. Installs the updated version with all TUI files"
            echo "    5. Verifies the installation"
            echo "    6. Preserves existing templates and configuration"
            echo ""
            echo "EXAMPLES:"
            echo "    mark upgrade"
            echo "    mark u"
        ...
        uninstall|un)
            ...
            echo ""
            echo "DESCRIPTION:"
            echo "    Removes all mark components from your system, including the enhanced TUI files."
            echo ""
            echo "WARNING:"
            echo "    This action cannot be undone. All templates and configuration will be removed."
            echo ""
            echo "REMOVALS:"
            echo "    • Executable: $HOME/.local/bin/mark"
            echo "    • TUI Files: $HOME/.local/bin/mark-tui and $HOME/.local/bin/mark-tui-enhanced"
            echo "    • Libraries: $HOME/.local/lib/mark/"
            echo "    • Configuration: $HOME/.mark/ (optional - user prompted)"
            echo ""
            echo "EXAMPLES:"
            echo "    mark uninstall"
            echo "    mark un"
